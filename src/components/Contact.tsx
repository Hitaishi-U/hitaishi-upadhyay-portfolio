...
export default function Contact({ className }: ContactProps) {
  ...
  return (
    <section className={`py-16 bg-gradient-to-br from-gradient-start to-gradient-end ${className}`}>
            ...
            <div className="space-y-6">
              {contactInfo.map((item) => (
                <a
                  ...
                  className="flex items-center space-x-4 p-4 bg-card rounded-lg hover:bg-accent transition-colors duration-200 group"
                >
            ...
            <div className="pt-6 border-t border-border">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors duration-200"
                >
